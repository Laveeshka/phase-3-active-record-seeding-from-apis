...
spells.each do |spell|
    ...
    #the response will come bak as a JSON-formatted string
    ...
    Spell.create(
        ...
        description: spell_hash["desc"][0] #spell_hash["desc"] returns an array, so we need to access the first index to get a string of the description
    )
end
